...
const char* ap_ssid     = "esp2866curtain";
...
void handleRoot() {
  ...
  String htmlRes  = headerHtml + "<body><h1>Smart Feeder</h1>"
    ...
    "<p><a href=\"#\"><button class=\"button button2\" onclick=\"restart()\">Restart</button></a></p>"
    "<p><a href=\"#\"><button class=\"button button2\" onclick=\"openCurtain()\">Open</button></a></p>"
    "<p><a href=\"#\"><button class=\"button button2\" onclick=\"closeCurtain()\">Close</button></a></p>"
    "<script>"
